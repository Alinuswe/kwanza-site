    ...
    <PageShell>
      ...
      <section className="px-6 py-20 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            eyebrow="Engage"
            title="Align your project with a systems-driven execution partner"
            description="Tell us what you need to deliver and we will define a practical execution approach."
          />
          <div className="mt-10">
